...
$unnaproved_comments_counts = checkStatus('comments', 'comment_status', 'unapproved');
...
?>
                ...
                <div class="row">
                    ...
                    $element_count  = [$post_counts,$post_published_counts,$post_draft_counts ,$comment_counts,$unnaproved_comments_counts ,$users_counts, $subscribers_counts,$categories_counts];
